<!-- This Code is Licensed by schwartz-edmisten.com -->
  function initRotatingImageChanger() {
    ...
    listItem.addEventListener('mouseover', handleListItemHover);      listItem.addEventListener('mouseout', handleListItemHoverOut);
